...
export default function Home() {
  return (
    <div className="card">
      ...
      <hr className="sep" />
      <p>After onboarding, visit the <span className="kbd">Buyer Feed</span> to accept/reject, then use the <span className="kbd">Match Workflow</span> to progress a deal.</p>
    </div>
  );
}
